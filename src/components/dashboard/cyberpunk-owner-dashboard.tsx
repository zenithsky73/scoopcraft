  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-[#05070f] text-slate-900 dark:text-slate-100 relative overflow-hidden font-sans pb-24 transition-colors duration-200 selection:bg-indigo-500 selection:text-white">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6 space-y-8">
        ...
        {/* ─── 1.6 AI ASSISTANT COPILOT QUICK ACCESS BANNER ─── */}
        <section className="p-4 sm:p-5 rounded-2xl bg-gradient-to-r from-indigo-500/10 via-purple-500/10 to-pink-500/10 border border-indigo-300/60 dark:border-indigo-500/30 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 shadow-sm">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-600 dark:text-slate-400">
                Tanyakan apa saja seputar cara membuat carousel dari YouTube, memilih template, ganti watermark, hingga tips viral!
              </p>
            </div>
          </div>
