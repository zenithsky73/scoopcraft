...
export const metadata = {
  title: 'Kebijakan Privasi - InstaDeck PRO',
  description: 'Kebijakan Privasi dan Perlindungan Data Pengguna InstaDeck PRO',
};
      ...
      <main className="flex-1 max-w-4xl mx-auto px-4 py-12 space-y-8">
        ...
        <div className="prose dark:prose-invert max-w-none space-y-6 text-sm sm:text-base leading-relaxed text-slate-700 dark:text-slate-300">
          <section className="space-y-3">
            ...
            <p>
              InstaDeck PRO (&quot;kami&quot;, &quot;layanan&quot;, atau &quot;InstaDeck&quot;) sangat menghargai dan berkomitmen untuk melindungi privasi data Anda. Kebijakan Privasi ini menjelaskan bagaimana kami mengumpulkan, menggunakan, menyimpan, dan melindungi informasi pribadi Anda saat menggunakan aplikasi web kami dan fitur integrasi media sosial (Instagram, TikTok, Threads, dan platform lainnya).
            </p>
          </section>

          <section className="space-y-3">
            <h2 className="text-xl font-bold text-slate-900 dark:text-white">2. Data yang Kami Kumpulkan</h2>
            <p>Saat Anda menggunakan InstaDeck PRO atau menghubungkan akun media sosial Anda, kami dapat mengumpulkan informasi berikut:</p>
            <ul className="list-disc pl-5 space-y-1">
              <li><strong>Informasi Akun:</strong> Nama, alamat email, dan kata sandi terenkripsi saat Anda mendaftar.</li>
              <li><strong>Informasi Otorisasi Media Sosial (Instagram / TikTok / Threads):</strong> User ID publik, nama akun, handle, dan Token Akses resmi yang diperlukan untuk melakukan penjadwalan dan publikasi konten otomatis atas izin Anda.</li>
          ...
          <section className="space-y-3">
            ...
            <ul className="list-disc pl-5 space-y-1">
              ...
              <li>Menerbitkan postingan media (gambar carousel, caption) ke akun Instagram, TikTok, atau Threads yang Anda pilih secara eksplisit.</li>
          ...
          <section className="space-y-3">
            ...
            <p>
              Anda memiliki hak penuh untuk mengakses, memperbarui, atau menghapus data Anda kapan saja. Anda dapat memutuskan tautan akun media sosial Anda melalui menu <strong>Pengaturan &gt; Akun Sosial</strong> di aplikasi, atau menghapus data otorisasi aplikasi melalui pengaturan platform terkait.
            </p>
            <p>
          ...
          <section className="space-y-3">
            ...
            <p>
              Jika Anda memiliki pertanyaan tentang Kebijakan Privasi ini, Anda dapat menghubungi kami melalui email di: <a href="mailto:91venture@gmail.com" className="text-primary underline">91venture@gmail.com</a>.
            </p>
          </section>
        </div>
      </main>
